...
public class AppAvaliacao1 {
    public static void main(String[] args) {
        ...
        System.out.println(String.format("O valor total da obra: $ %.2f reais" , obra1.calcularValorTotalDaObra()));
        System.out.println(obra1.listarDadosDaObra());

       
        /*  teste
        System.out.println(fase1.calcularValorTotalDaFaseDaObra());
        System.out.println(fase2.calcularValorTotalDaFaseDaObra());
        */
